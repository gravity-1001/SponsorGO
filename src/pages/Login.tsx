...
const Login = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      toast({
        title: "Login information received",
        ...
        <Card>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link to="/forgot-password" className="text-sm text-sponsorgo-purple hover:underline">
                    Forgot password?
                  </Link>
                </div>
          ...
          <CardFooter className="flex justify-center border-t pt-6">
            <p className="text-sm text-gray-600">
              ...
              <Link to="/signup" className="text-sponsorgo-purple hover:underline font-medium">
                Sign up
              </Link>
            </p>
          </CardFooter>
